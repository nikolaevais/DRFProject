...
class Command(BaseCommand):
    def handle(self, *args, **options):
        payment_list = [
            {'client': User.objects.get(pk=2), 'date_payment': '2024-08-06', 'payment_course': Сourse.objects.get(pk=4),
             'payment_amount': '5000', 'method_payment': 'CASH'},
            {'client': User.objects.get(pk=3), 'date_payment': '2024-08-07', 'payment_course': Сourse.objects.get(pk=3),
            ...
            {'client': User.objects.get(pk=5), 'date_payment': '2024-08-08', 'payment_course': Сourse.objects.get(pk=4),
             'payment_amount': '3000', 'method_payment': 'TRANSFER'},
            {'client': User.objects.get(pk=6), 'date_payment': '2024-08-09', 'payment_course': Сourse.objects.get(pk=3),
            ...
            {'client': User.objects.get(pk=2), 'date_payment': '2024-08-09', 'payment_course': Сourse.objects.get(pk=2),
             'payment_amount': '7000', 'method_payment': 'TRANSFER'},
            {'client': User.objects.get(pk=3), 'date_payment': '2024-08-10', 'payment_course': Сourse.objects.get(pk=2),
            ...
            {'client': User.objects.get(pk=5), 'date_payment': '2024-08-11', 'payment_course': Сourse.objects.get(pk=2),
